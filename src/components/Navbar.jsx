    ...
    <>
      ...
      <nav className="bg-[#131A22] text-white py-3">
        <div className="max-w-screen-xl mx-auto px-4">
          {/* Top row: logo‐deliver, search (lg+), links (lg+), burger (md<) */}
          <div className="flex items-center">
            ...
            {/* Search Bar (lg+) */}
            <div className="hidden lg:flex flex-1 items-center mr-6">
            ...
            {/* Mobile: Burger icon (always visible < lg) */}
